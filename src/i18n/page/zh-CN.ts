...
t.home.desc.list = [
  ...
  "基于最新的Spring Cloud Alibaba、Spring Cloud Gateway、Spring Boot、SpringSecurity、Flowable、Sentinel、Skywalking、Seata、Nacos、Mybatis、Vue3、Element-Plus、TypeScript、Vite开发",
...
t.logLogin.operation0 = "登录成功";
t.logLogin.operation1 = "登录失败";
t.logLogin.operation2 = "退出成功";
t.logLogin.ip = "操作IP";
