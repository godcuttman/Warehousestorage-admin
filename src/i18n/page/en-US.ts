...
t.home.desc.list = [
  ...
  "Based on the latest development of Spring Cloud Alibaba、Spring Cloud Gateway、Spring Boot、SpringSecurity、Flowable、Sentinel、Skywalking、Seata、Nacos、Mybatis、Vue3、Element-Plus、TypeScript、Vite",
...
t.logLogin.operation0 = "SUCCESS";
t.logLogin.operation1 = "FAIL";
t.logLogin.operation2 = "Exit";
t.logLogin.ip = "IP";
