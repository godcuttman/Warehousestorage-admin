<template>
  <div class="panel-tab__content">
    ...
    <div class="element-property list-property">
      ...
      >
      <el-table :data="fieldList" show-overflow-tooltip max-height="240" border fit>
    ...
    <el-drawer v-model="fieldModelVisible" title="字段配置" :size="`${width}px`" append-to-body destroy-on-close>
      ...
      <el-table key="property-table" :data="fieldPropertiesList" show-overflow-tooltip max-height="240" border fit>
        <el-table-column label="序号" width="50px" type="index" />
